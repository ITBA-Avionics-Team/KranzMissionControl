...
const TemperatureSensor = ({ name, coords, onMouseEnter, onMouseLeave }) => {
  ...
  return (
      <svg style={sensorStyle} onMouseEnter={() => onMouseEnter(name)} onMouseLeave={() => onMouseLeave(name)} xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
