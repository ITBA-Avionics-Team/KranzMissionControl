...
const LoadingDiagram = ({ systemStatus }) => {
  ...
  return (
    <div ref={elementRef} style={containerStyle} onMouseMove={handleMouseMove} >
			...
			<Text name="tank_depress_vent_temp_celsius" value={systemStatus.on_board.tank_depress_vent_temp_celsius +  "°C"} coords={{x:18.5, y:5}} onMouseEnter={displayNameOnCursor} onMouseLeave={clearCursorName}/>
			...
			<Text name="tank_temperature" value={systemStatus.on_board.tank_temp_celsius +  "°C"} coords={{x:21.5, y:20}} onMouseEnter={displayNameOnCursor} onMouseLeave={clearCursorName}/>
			<PressureSensor name="tank_pressure" coords={{x:20, y:25}} onMouseEnter={displayNameOnCursor} onMouseLeave={clearCursorName}/>
			<Text name="tank_pressure" value={systemStatus.on_board.tank_pressure_psi +  " PSI"} coords={{x:21.5, y:25}} onMouseEnter={displayNameOnCursor} onMouseLeave={clearCursorName}/>
